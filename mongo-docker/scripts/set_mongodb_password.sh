...
MONGODB_ADMIN_PASS=${MONGODB_ADMIN_PASS:-"t,tE3/7a,NxQPFD"}
 
# Application Database User
MONGODB_APPLICATION_DATABASE=${MONGODB_APPLICATION_DATABASE:-"eeap"}
MONGODB_APPLICATION_USER=${MONGODB_APPLICATION_USER:-"eeap"}
MONGODB_APPLICATION_PASS=${MONGODB_APPLICATION_PASS:-"HUJuZ8Cab5uCR"}
...
echo ""
echo "	mongo eeap -u $MONGODB_APPLICATION_USER -p $MONGODB_APPLICATION_PASS --host 127.0.0.1 --port 27017"
echo ""
echo "========================================================================"
