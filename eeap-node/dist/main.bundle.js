...
module.exports = "<h1>Our MongoDB is Working!</h1>\n\n<ul>\n  <li *ngFor=\"let report of reports\" (click)=\"onSelect(report)\">{{ report.name }}</li>\n</ul>\n"
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.onSelect = function (report) {
...
var ReportComponent = (function () {
    function ReportComponent(_dataService) {
        var _this = this;
        this._dataService = _dataService;
        this._dataService.getReport("59c93760ce5cfd6dfa0f3999")
            .subscribe(function (res) { return _this.report = res; });
    }
